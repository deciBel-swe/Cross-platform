...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i1038.UploadRemoteDatasource>(
      () => _i1038.UploadRemoteDatasource(gh<_i667.DioClient>()),
    );
    gh.lazySingleton<_i199.IUploadRepository>(
      () => _i755.UploadRepository(gh<_i1038.UploadRemoteDatasource>()),
    );
    gh.lazySingleton<_i589.IAuthRepository>(
