    ...
    return Row(
      children: [
        ...
        GestureDetector(
          ...
          onTap: isLoading ? null : () => ref.read(uploadNotifierProvider.notifier).pickCoverImage(),
          child: Container(
            width: 100,
            height: 100,
            decoration: BoxDecoration(
              ...
              image: metadata.coverImage != null
                  ? DecorationImage(image: FileImage(metadata.coverImage!), fit: BoxFit.cover)
                  : null,
            ),
            // Show a placeholder icon if no image is selected
            child: metadata.coverImage == null
                ? const Icon(Icons.camera_alt_outlined, color: AppColors.textSecondary, size: 30)
                : null,
          ),
        ),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              const Text('File name', style: TextStyle(color: AppColors.textSecondary, fontSize: 12)),
