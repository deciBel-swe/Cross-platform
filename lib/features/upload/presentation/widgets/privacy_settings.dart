    ...
    return Column(
      ...
      children: [
        ...
        ListTile(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: AppColors.proBadge.withValues(alpha: 0.2),
          ...
          subtitle: const Text(
            'Require listener to follow you to access',
            style: TextStyle(color: AppColors.textHint),
          ),
          trailing: const Icon(
        ...
        Row(
          ...
          children: [
            ...
            Switch(
              ...
              onChanged: (isLoading || !isArtistPro)
                  ? null
                  : (val) async {
                      if (val) {
                        ...
                        if (date != null && context.mounted) {
                          ...
                          if (time != null) {
                            ...
                            ref
                                .read(uploadNotifierProvider.notifier)
                                .updateReleaseDate(scheduledDateTime);
        ...
        Builder(
          builder: (context) {
            ...
            if (!isArtistPro) {
              ...
              isBoxActive =
                  false; // Keep it looking "locked" but with real data
  ...
  Widget _buildDateTimeBox({required String text, required bool isActive}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: isActive ? AppColors.textMuted : Colors.transparent,
        ),
      ),
      child: Text(
        text,
        style: TextStyle(
          color: isActive
              ? AppColors.onPrimary
              : AppColors.textHint, // Dimmed if inactive
          fontWeight: FontWeight.bold,
        ),
      ),
    );
