...
abstract class $ConversationModelCopyWith<$Res> {
  ...
  $Res call({
    String id,
    @JsonKey(fromJson: _participantsFromJson) List<int> participants,
    String lastMessage,
    @JsonKey(fromJson: _parseDateTime) DateTime lastTimestamp,
    int unreadCount,
  });
}
...
class _$ConversationModelImpl implements _ConversationModel {
  const _$ConversationModelImpl({
    required this.id,
    @JsonKey(fromJson: _participantsFromJson)
    final List<int> participants = const <int>[],
    this.lastMessage = '',
    @JsonKey(fromJson: _parseDateTime) required this.lastTimestamp,
    this.unreadCount = 0,
  ...
  @override
  String toString() {
    return 'ConversationModel(id: $id, participants: $participants, lastMessage: $lastMessage, lastTimestamp: $lastTimestamp, unreadCount: $unreadCount)';
  }
...
abstract class _ConversationModel implements ConversationModel {
  const factory _ConversationModel({
    ...
    @JsonKey(fromJson: _participantsFromJson) final List<int> participants,
    final String lastMessage,
    @JsonKey(fromJson: _parseDateTime) required final DateTime lastTimestamp,
    final int unreadCount,
  }) = _$ConversationModelImpl;
