...
abstract class $RefreshTokenResponseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String accessToken, int expiresIn, String? refreshToken});
}
...
class _$RefreshTokenResponseModelImpl implements _RefreshTokenResponseModel {
  ...
  @override
  String toString() {
    return 'RefreshTokenResponseModel(accessToken: $accessToken, expiresIn: $expiresIn, refreshToken: $refreshToken)';
  }
