...
```json
{
  "token": "Chirographum commodi absens eveniet patrocinor architecto adfectus statim. Vesper volaticus cunae. Animi vir harum.",
  "newPassword": "Haya123"
}
```
...
## PATCH Change current user email
...
## DELETE delete current user avatar

DELETE /me/images/avatar
...
## DELETE delete current user cover

DELETE /me/images/cover
...
## GET Get all tracks reposted by a user
...
| HTTP Status Code | Meaning                                                 | Description           | Data schema |
| ---------------- | ------------------------------------------------------- | --------------------- | ----------- |
| 200              | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | User tracks retrieved | Inline      |
...
| ------------ | -------- | ------------ | -------- | ----------- |
| body         | body     | object       | yes      | none        |
| » profilePic | body     | string(file) | no       | none        |
| » coverPic   | body     | string(file) | no       | none        |
...
| Name        | Type                              | Required | Restrictions | Title | description |
| ----------- | --------------------------------- | -------- | ------------ | ----- | ----------- |
| _anonymous_ | [[SearchUser](#schemasearchuser)] | false    | none         |       | none        |
| » id        | integer                           | false    | none         |       | none        |
| » username  | string                            | false    | none         |       | none        |
...
| Name        | Type                                      | Required | Restrictions | Title | description |
| ----------- | ----------------------------------------- | -------- | ------------ | ----- | ----------- |
| _anonymous_ | [[SearchPlaylist](#schemasearchplaylist)] | false    | none         |       | none        |
| » id        | integer                                   | false    | none         |       | none        |
...
## GET Get all tracks of another user
...
```yaml
audioFile: file://C:\Users\User\Desktop\Semester 6\Software
  Engineering\Project\Upload Testing\wind.mp3
coverImage: file://C:\Users\User\Desktop\Semester 6\Software
  Engineering\Project\Upload Testing\oAuth-large-figure.png
title: Wind
genre: Background Noise
description: Windy noise
isPrivate: "false"
waveformData: "[1.0,1.0,0.85]"
releaseDate: 2025-10-26
tags: '["noise","relaxing","very relaxing"]'
```
...
POST /tracks/{trackId}/regenerate-token
...
tags: '["amazing","amazing song", "fourth one"]'
...
## GET Get track with token

GET /tracks/token/{token}
...
## GET Get HTML iframe embed code for a tracks

GET /tracks/{tracksId}/embed

### Params

| Name     | Location | Type   | Required | Description |
| -------- | -------- | ------ | -------- | ----------- |
| tracksId | path     | string | yes      | none        |
...
| Name         | Type                                      | Required | Restrictions | Title | description |
| ------------ | ----------------------------------------- | -------- | ------------ | ----- | ----------- |
| _anonymous_  | [[ReportResponse](#schemareportresponse)] | false    | none         |       | none        |
| » id         | integer                                   | false    | none         |       | none        |
...
## GET Get playlist with token

GET /playlists/token/{token}
...
## PATCH Update playlist metadata
...
## PATCH Reorder tracks inside a playlist
...
## POST regenerate secret link

POST /playlists/{playlistId}/secret-link/regenerate
...
| Name        | Type   | Required | Restrictions | Title | description |
| ----------- | ------ | -------- | ------------ | ----- | ----------- |
| » secretUrl | string | true     | none         |       | none        |
...
POST /tracks/{playlistId}/like

### Params

| Name       | Location | Type    | Required | Description |
| ---------- | -------- | ------- | -------- | ----------- |
| playlistId | path     | integer | yes      | none        |
...
## DELETE Remove like from a playlist

DELETE /tracks/{playlistId}/like
...
| HTTP Status Code | Meaning                                                      | Description     | Data schema                                                   |
| ---------------- | ------------------------------------------------------------ | --------------- | ------------------------------------------------------------- |
| 201              | [Created](https://tools.ietf.org/html/rfc7231#section-6.3.2) | Comment created | [Reply to comment Response](#schemareply to comment response) |
...
| HTTP Status Code | Meaning                                                 | Description        | Data schema |
| ---------------- | ------------------------------------------------------- | ------------------ | ----------- |
| 200              | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | Paginated comments | Inline      |
...
| »» id           | integer                           | true     | none         |       | none        |
| »» user         | [CommentUser](#schemacommentuser) | true     | none         |       | none        |
| »»» id          | integer                           | false    | none         |       | none        |
| »»» username    | string                            | false    | none         |       | none        |
...
| Name         | Type                                                  | Required | Restrictions | Title | description |
| ------------ | ----------------------------------------------------- | -------- | ------------ | ----- | ----------- |
| _anonymous_  | [[TrendingTrack](#schematrendingtrack)]               | false    | none         |       | none        |
| » id         | integer                                               | false    | none         |       | none        |
| » title      | string                                                | false    | none         |       | none        |
...
<h2 id="tocS_UpdatePlaylistRequest ">UpdatePlaylistRequest </h2>

<a id="schemaupdateplaylistrequest "></a>
<a id="schema_UpdatePlaylistRequest "></a>
<a id="tocSupdateplaylistrequest "></a>
<a id="tocsupdateplaylistrequest "></a>
...
| CoverArt    | string                              | false    | none         |       | none        |
...
<h2 id="tocS_Reply to comment Response">Reply to comment Response</h2>

<a id="schemareply to comment response"></a>
<a id="schema_Reply to comment Response"></a>
<a id="tocSreply to comment response"></a>
<a id="tocsreply to comment response"></a>
...
<h2 id="tocS_PaginatedPlaylistResponse">PaginatedPlaylistResponse</h2>

<a id="schemapaginatedplaylistresponse"></a>
<a id="schema_PaginatedPlaylistResponse"></a>
<a id="tocSpaginatedplaylistresponse"></a>
<a id="tocspaginatedplaylistresponse"></a>
...
| Name          | Type                                          | Required | Restrictions | Title | Description |
| ------------- | --------------------------------------------- | -------- | ------------ | ----- | ----------- |
| content       | [[PlaylistResponse](#schemaplaylistresponse)] | false    | none         |       | none        |
| pageNumber    | integer                                       | false    | none         |       | none        |
| pageSize      | integer                                       | false    | none         |       | none        |
| totalElements | integer                                       | false    | none         |       | none        |
| totalPages    | integer                                       | false    | none         |       | none        |
...
| email           | string(email)                                   | false    | none         |       | none        |
| username        | string                                          | false    | none         |       | none        |
| isBlocked       | string                                          | true     | none         |       | none        |
...
| isFollowed  | boolean                                                     | true     | none         |       | none        |
| tier        | [PublicTier](#schemapublictier)                             | false    | none         |       | none        |
...
| user             | [CommentUser](#schemacommentuser) | true     | none         |       | none        |
| body             | string                            | true     | none         |       | none        |
| timestampSeconds | integer¦null                      | false    | none         |       | none        |
| createdAt        | string(date-time)                 | false    | none         |       | none        |
